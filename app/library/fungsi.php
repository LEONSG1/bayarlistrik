...
include __DIR__ . '/../config/koneksi.php'; // Periksa apakah ini adalah tempat yang tepat untuk mengakses file koneksi.php
...
class oop {
    ...
    function simpan($table, array $field) {
        ...
        $sql = rtrim($sql, ',');
        $jalan = mysqli_query($connection, $sql); // Tambahkan $connection sebagai parameter pertama
    }

    function tampil($table, $where, $cari) {
        global $connection;

        $sql = mysqli_query($connection, "SELECT * FROM $table $where $cari");
        $jalan = [];
    ...
    function edit($table, $where) {
        ...
        $query = mysqli_query($connection, $sql); // Tambahkan $connection sebagai parameter pertama
    ...
    function hapus($table, $where) {
        ...
        $sql = mysqli_query($connection, "DELETE FROM $table WHERE $where"); // Tambahkan $connection sebagai parameter pertama
        return $sql;
    }
  ...
  function login($table, $username, $password, $alamat) {
    ...
    global $connection; // Pastikan koneksi database tersedia dalam fungsi ini

    // Menghapus semua sesi yang ada
    

    // Menghindari SQL Injection dengan menggunakan prepared statement
    $stmt = mysqli_prepare($connection, "SELECT * FROM $table WHERE username = ? AND password = ?");
