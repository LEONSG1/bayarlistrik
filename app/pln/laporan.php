												...
												<?php  
													...
													if ($data=="") {
														...
														<?php  
															if($cek >= 3){
																$no++; 
																$sum = mysqli_fetch_array(mysqli_query($connection, "SELECT id_pelanggan,COUNT(bulan) as bln_tunggak,sum(jumlah_bayar) jml_bayar,SUM(jumlah_meter) as jml_meter,tarif_perkwh FROM tagihan WHERE id_pelanggan = '$r[id_pelanggan]' AND status = 'Belum Bayar'"));
																$bulan = mysqli_query($connection, "SELECT * FROM tagihan WHERE id_pelanggan = '$r[id_pelanggan]' AND status = 'Belum Bayar' ");
																?>
																<tr>
																	<td align="center"><?php echo $no; ?>.</td>
																	<td align="center"><?php echo $r['id_pelanggan'] ?></td>
								...
								<div class="col-md-12">
									<form method="post">
										<div class="input-group">
											...
											<datalist id="id_pel">
												<?php  
													$a = mysqli_query($connection, "SELECT * FROM pelanggan");
									...
									<div class="table-responsive">
										<table class="table table-bordered table-striped table-hover">
											...
											<tbody>
												...
												<?php } } 
													@$sum = mysqli_fetch_array(mysqli_query($connection, "SELECT SUM(jumlah_meter) as meter,SUM(jumlah_bayar) as bayar FROM tagihan WHERE id_pelanggan = '$id_pelanggan' AND tahun = '$tahun'"));
												?>
											</tbody>
											<tfoot>
												<tr>
