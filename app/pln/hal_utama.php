...
// Periksa apakah 'nama_petugas' ada di dalam session
if (isset($_SESSION['nama_petugas'])) {
	echo $_SESSION['nama_petugas'];
} else {
	// Tampilkan pesan atau lakukan tindakan lain jika 'nama_petugas' tidak ada
	echo "Nama petugas tidak ditemukan.";
}
?>
						...
						<ul class="nav navbar-nav navbar-right" style="margin-right: 50px;">
							<li class="dropdown">
								<a href="#" class="dropdown-toggle" data-toggle="dropdown" id="akun">
									...
									<strong><?php echo isset($_SESSION['nama_petugas']) ? $_SESSION['nama_petugas'] : 'Nama Petugas Tidak Tersedia'; ?></strong>&nbsp;
									<span class="caret"></span>
								</a>
